...
import {
  ...
  HUNTER_SHOT_TIMEOUT_MS as BASE_HUNTER_SHOT_TIMEOUT_MS,
  MAYOR_SELECTION_TIMEOUT_MS as BASE_MAYOR_SELECTION_TIMEOUT_MS,
  MAX_VISIBLE_LOGS,
...
const HUNTER_SHOT_TIMEOUT_MS = IS_E2E ? 30 * 1000 : BASE_HUNTER_SHOT_TIMEOUT_MS;
const MAYOR_SELECTION_TIMEOUT_MS = IS_E2E ? 30 * 1000 : BASE_MAYOR_SELECTION_TIMEOUT_MS;
const MIN_PLAYERS = BASE_MIN_PLAYERS;
const DEFAULT_DISCUSSION_TIMER_SECONDS = IS_E2E ? 0 : 60;
